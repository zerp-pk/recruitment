...
import { EditJobLocationProps, EditJobLocationFormData } from './types';
...
export default function EditJobLocation({ joblocation, onSuccess }: EditJobLocationProps) {
    ...
    return (
        <DialogContent>
            <DialogHeader>
                <DialogTitle>{t('Edit Job Location')}</DialogTitle>
            </DialogHeader>
